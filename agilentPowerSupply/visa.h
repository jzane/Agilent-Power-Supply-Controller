...
/*
   ...
   The default value for VI_AGATTR_RETURN_ALL is VI_FALSE.
   This is more consistent with the way Agilent VISA works in version 16.3 and earlier.
*/
#define VI_AGATTR_RETURN_ALL (0x0FFF0062L) /* ViBoolean (R/W) global DefaultRM attribute */
